...
const Home = () => {
  return (
    <div>
      ...
      <p>
        Are you looking to bring a new furry friend into your life? At Puppy Power, we show a wide selection of adorable puppies
        ...
        Browse some of our favorite pups, learn about each breed, and discover valuable resources to help you care for your new friend.
      </p>
    </div>
  );
};
